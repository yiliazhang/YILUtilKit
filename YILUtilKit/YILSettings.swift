...
open class YILSettings: NSObject {
    public static let shared = YILSettings()
    fileprivate override init(){
        super.init()
    }
    
    private class func encodeBase64(string: String) -> String {
    ...
    private class func decodeBase64(string: String) -> String {
