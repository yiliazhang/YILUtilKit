...
extension YIL where Base: UIView {
    func roundRect(_ radius: CGFloat = 0,borderWidth: CGFloat = 0, borderColor: UIColor = .clear) {
    ...
    func shadow(_ radius: CGFloat = 0, offsetX: CGFloat = 0, offsetY: CGFloat = 0, color: UIColor = .clear, alpha: Float = 1.0) {
